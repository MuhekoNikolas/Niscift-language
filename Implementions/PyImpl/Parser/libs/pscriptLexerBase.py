...
class pscriptLexerBase(Lexer):
    ...
    def HandleSpaces(self) -> None:
        ...
        if ((self.__last_token is None or self.__last_token.type == self.NEWLINE) and
            ...
            #
            #  -- https://docs.pscript.org/3.1/reference/lexical_analysis.html#indentation

            indent: int = 0

            for i in range(0, len(self.text)):
                indent += pscriptLexerBase.tab_size - indent % pscriptLexerBase.tab_size if self.text[i] == '\t' else 1
